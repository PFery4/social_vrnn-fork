...
def parse_args():
    ...
    # Module selection
    freeze_feature_extraction_module = False
    freeze_proba_inference_module = False
    freeze_output_proba_module = False
    ...
    parser.add_argument('--freeze_feature_extraction_module',
                        help='Freeze the weights of the input feature extraction module', type=bool,
                        default=freeze_feature_extraction_module)
    parser.add_argument('--freeze_proba_inference_module',
                        help='Freeze the weights of the probabilistic inference module', type=bool,
                        default=freeze_proba_inference_module)
    parser.add_argument('--freeze_output_proba_module', help='Freeze the weights of the output probability module',
                        type=bool, default=freeze_output_proba_module)
