...
# small tests
# python3 train.py --exp_num 1000003 --model_name WIP_SocialVRNN --n_mixtures 3 --output_pred_state_dim 4 --scenario real_world/ewap_dataset/seq_hotel --gpu false --prev_horizon 7 --prediction_horizon 12 --dt 0.4 --others_info relative --pedestrian_vector_dim 4 --batch_size 16 --total_training_steps 400;
